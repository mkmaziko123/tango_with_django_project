...
def index(request):
    ...
    visitor_cookie_handler(request)  # Update visit counter in session
    
    # Pass visits to the template but we won't display it on the homepage
...
def about(request):
    ...
    return render(request, 'rango/about.html', context)  # Render the about page
